package com.madhusudhan.wr.allaboutlambdas.specializedfunctions;
...
/**
 * Class that demonstrates specialized functions for primitives usage
 *
 * @author mkonda
 *
 */
public class SpecializedFunctions {
    ...
    private void specializedSuppliers() {
    ...
    /**
     * Functions specialized for primitives
     */
    private void specializedFunctions() {
        // Using non-specialized function
        Function<Integer, Employee> empFunction = null;
        // Converting to a specialized function
    ...
    private void unitypeSpecializedFunctions() {
    ...
    public static void main(String[] args) {
        new SpecializedFunctions().checkEvenNumber(91);
        new SpecializedFunctions().specializedConsumers();
        new SpecializedFunctions().unitypeSpecializedFunctions();
    }
}
